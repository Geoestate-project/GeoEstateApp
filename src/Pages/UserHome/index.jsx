                    ...
                    <Col md={8}>
                        ...
                        <Form>
                            ...
                            <Form.Group className="mb-3">
                                <Form.Label>
                                    {searchOption === "Address" ? "Street and property number" : "Cadastral reference"}
                                </Form.Label>
                                <Form.Control
                                    type="text"
                                    placeholder={searchOption === "Address" ? "Enter the street and number" : "Enter the cadastral reference"}
                                    value={inputValue}
                                    onChange={handleInputChange}
                                />
                            </Form.Group>
                            <Button variant="secondary" className="mr-2" onClick={handleClean}>
                                Clean
                            </Button>
                            <Button variant="success" style={{ backgroundColor: 'var(--color)' }} onClick={handleAppreciate}>
                                Appreciate
                            </Button>
                        </Form>
                    </Col>
